...
public class NewsAdpater extends ArrayAdapter<Newsnetwork> {

    public NewsAdpater(Context context, ArrayList<Newsnetwork> news) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Newsnetwork currentNews = getItem(position);
